    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link href="/dashboard/teacher/courses" className="group">
          ...
          <Link href="/dashboard/teacher/assignments" className="group">
          ...
          <Link href="/dashboard/teacher/grades" className="group">
